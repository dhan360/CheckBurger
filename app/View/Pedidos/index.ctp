<div class="pedidos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('id_periodo'); ?></th>
			<th><?php echo $this->Paginator->sort('id_locale'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($pedido['Pedido']['id_user']); ?>&nbsp;</td>
		<td><?php echo h($pedido['Pedido']['total']); ?>&nbsp;</td>
		<td><?php echo h($pedido['Pedido']['estado']); ?>&nbsp;</td>
		<td><?php echo h($pedido['Pedido']['id_periodo']); ?>&nbsp;</td>
		<td><?php echo h($pedido['Pedido']['id_locale']); ?>&nbsp;</td>
		<td class="actions">
